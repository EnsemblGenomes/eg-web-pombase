...
dna        => qq{<a rel="external"  title="$title{'dna'}" href="$ftp_base_path_stub/FASTA">FASTA</a> (DNA)},
cdna       => qq{<a rel="external"  title="$title{'cdna'}" href="$ftp_base_path_stub/FASTA">FASTA</a> (cDNA)},
ncrna      => qq{<a rel="external"  title="$title{'ncrna'}" href="$ftp_base_path_stub/FASTA">FASTA</a> (ncRNA)},
prot       => qq{<a rel="external"  title="$title{'prot'}" href="$ftp_base_path_stub/FASTA">FASTA</a> (protein)},
embl       => qq{<a rel="external"  title="$title{'embl'}" href="$ftp_base_path_stub/pombe/Chromosome_Dumps/} . $sp_dir . qq{/">EMBL</a>},
genbank    => qq{<a rel="external"  title="$title{'genbank'}" href="$ftp_base_path_stub/pombe/Chromosome_Dumps/} . $sp_dir . qq{/">GenBank</a>},
#gtf        => qq{<a rel="external"  title="$title{'gtf'}" href="$ftp_base_path_stub/pombe/Chromosome_Dumps">GTF</a>},
gff3       => qq{<a rel="external"  title="$title{'gff3'}" href="$ftp_base_path_stub/pombe/Chromosome_Dumps">GFF3</a>},
#mysql      => join('<br/>',@mysql),
